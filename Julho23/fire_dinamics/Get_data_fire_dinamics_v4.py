# -*- coding: utf-8 -*-
"""
Created on Tue Jul 18 12:05:47 2023
    ...
    for i in range(0,len(files)):
      with fs.open(files[i], 'rb') as f:
        ...
        try:
            ...
            results = str(code) +','+ str(lat)+','+ str(lon)+','+ str(sum_frp)+','+ str(mean_frp)+','+ str(N_frp)+','+ str(mean_temp)+','+ str(N_temp)+','+ str(N_smold)+','+ str(N_flame)
...
outfile = outdir+'goes_data_fire_dinamics_amazon_small_box_test_flame_smold_v4.csv'
###############################################################################
...
# end = time.time()
# print(end - start)
start_year,end_year,start_day,end_day,start_hour,end_our = 2020,2020,215,255,0,24
# start = time.time()
